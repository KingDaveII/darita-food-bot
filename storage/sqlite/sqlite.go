...
// New creates a new SQLite storage instance with the given database path.
...
// Save inserts a new page into the database.
...
// IsExists checks if a page with the given URL exists in the database.
